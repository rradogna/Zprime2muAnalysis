...
samples = [
    ...
    sample('zpsi5000',  'Z\'_{#psi} (1 TeV) #rightarrow #mu^{+}#mu^{-}',  '/ZprimeToMuMu_M-5000_Tune4C_13TeV-pythia8/Phys14DR-PU20bx25_tsg_PHYS14_25_V1-v1/AODSIM',      97890,  48, 0.05,  0.0369,  k_factor=1.3, is_zprime=True),
    sample('dy200',  'DY200',                                               '/DYJetsToEEMuMu_M-200To400_13TeV-madgraph/Phys14DR-PU20bx25_PHYS14_25_V1-v1/AODSIM', 26430,  37, 0.05, 2.208E-5, k_factor=1.024),
    sample('dy120',  'DY120',                                               '/DYJetsToEEMuMu_M-120To200_13TeV-madgraph/Phys14DR-PU20bx25_PHYS14_25_V1-v2/AODSIM', 60756,  37, 0.05, 2.208E-5, k_factor=1.024),
...
#dy200.ana_dataset  = '/DYJetsToEEMuMu_M-200To400_13TeV-madgraph/rradogna-datamc_dy200-a8881ceec144e0dfafbb7486d1b7f8e6/USER'
#dy120.ana_dataset  = '/DYJetsToEEMuMu_M-120To200_13TeV-madgraph/rradogna-datamc_dy120-a8881ceec144e0dfafbb7486d1b7f8e6/USER'
#big_warn('nothing')
