...
###################################################################
f1tev_at8tev = ROOT.TFile('./files/zp2mu_dy120_8TM.root')
...
f1tev_at13tev = ROOT.TFile('./files/zp2mu_dy120_13TM.root')
...
leg.AddEntry(h1tev_at8tev, " DY 120GeV @ 8TeV (Tracker Muon)", "L")
leg.AddEntry(h1tev_at13tev, " DY 120GeV @ 13TeV (Tracker Muon)", "L")
...
h1tev_at8tev.Scale(1/nGen_8tev)
h1tev_at13tev.Scale(1/nGen_13tev)
#h5tev.Rebin(10)
h1tev_at8tev.Rebin(1)
h1tev_at13tev.Rebin(1)
...
h1tev_at8tev.GetXaxis().SetRangeUser(0, 1000)
h1tev_at13tev.GetXaxis().SetRangeUser(0, 1000)
h1tev_at13tev.Draw("histo")
h1tev_at8tev.Draw("same histo")
leg.Draw()
c_mass.Print('TMABSDY120superimposition_mass.pdf')
...
pad1.cd()
hprob_8tev_iterOldBB.Scale(1/nGen_8tev)
hprob_13tev_iterOldBB.Scale(1/nGen_13tev)
...
hprob_13tev_iterOldBB.SetMaximum(0.004)
#hprob_8tev_iterOldBB.SetMaximum(0.022)
...
pad2.cd()
hprob_13tev_iterNewBB.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
pad3.cd()
hprob_8tev_iterOldEE.Scale(1/nGen_8tev)
hprob_13tev_iterOldEE.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
hprob_13tev_iterOldEE.SetMaximum(0.0055)
#hprob_8tev_iterOldEE.SetMaximum(0.005)
...
hprob_13tev_iterNewEE.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
pad5.cd()
hprob_8tev_iterOldEB.Scale(1/nGen_8tev)
hprob_13tev_iterOldEB.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
hprob_13tev_iterOldEB.SetMaximum(0.016)
#hprob_8tev_iterOldEB.SetMaximum(0.0065)
hprob_13tev_iterOldEB.Draw("histo")
hprob_8tev_iterOldEB.Draw("histo same")
#h1tev_at8tev_iterVSprobB_iter0.Draw("colz")
pad6.cd()
#hprob_8tev_iterNewEE.Scale(1/hprob_8tev_iterNewEE.Integral())
hprob_13tev_iterNewEB.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
c_scat.Print('TMABSDY120superimposition_iterVSvtxprob.pdf')
...
pad1.cd()
hprob_8tev_iter0.Scale(1/nGen_8tev)
hprob_13tev_iter0.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
#hprob_13tev_iter0.SetMaximum(0.13)
hprob_8tev_iter0.Draw("histo")
hprob_13tev_iter0.Draw("histo same")
#h1tev_at8tev_iterVSprobB_iter0.Draw("colz")
pad2.cd()
hprob_8tev_iter2.Scale(1/nGen_8tev)
hprob_13tev_iter2.Scale(1/nGen_13tev)
...
#hprob_13tev_iter2.SetMaximum(0.03)
hprob_8tev_iter2.Draw("histo")
hprob_13tev_iter2.Draw("histo same")
pad3.cd()
#hprob_8tev_iter9.Scale(1/hprob_8tev_iter9.Integral())
hprob_13tev_iter9.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
hprob_13tev_iter10.Scale(1/nGen_13tev)
...
c_scat.Print('TMABSDY120superimposition_iterVSprobBarrel.pdf')
...
pad1.cd()
hprob_8tev_iter0E.Scale(1/nGen_8tev)
hprob_13tev_iter0E.Scale(1/nGen_13tev)
#hprob_8tev_iter0.Rebin(20)
#hprob_13tev_iter0.Rebin(20)
...
#hprob_13tev_iter0E.SetMaximum(0.06)
hprob_8tev_iter0E.Draw("histo")
hprob_13tev_iter0E.Draw("histo same")
#h1tev_at8tev_iterVSprobB_iter0.Draw("colz")
pad2.cd()
hprob_8tev_iter2E.Scale(1/nGen_8tev)
hprob_13tev_iter2E.Scale(1/nGen_13tev)
...
hprob_13tev_iter10E.Scale(1/nGen_13tev)
...
c_scat.Print('TMABSDY120superimposition_iterVSprobEndcap.pdf')
...
h1tev_at8tev_chi_overf.Scale(1/nGen_8tev)
h1tev_at13tev_chi_overf.Scale(1/nGen_13tev)
...
leg.Draw()
c_over.Print('TMABSDY120superimposition_Chioverflow.pdf')
#
...
pad1.cd()
#pad1.SetLogy()
h1tev_at8tev_prob_BB.Scale(1/nGen_8tev)
h1tev_at13tev_prob_BB.Scale(1/nGen_13tev)
...
pad2.cd()
#pad2.SetLogy()
h1tev_at8tev_prob_EE.Scale(1/nGen_8tev)
h1tev_at13tev_prob_EE.Scale(1/nGen_13tev)
...
pad3.cd()
#pad3.SetLogy()
h1tev_at8tev_prob_EB.Scale(1/nGen_8tev)
h1tev_at13tev_prob_EB.Scale(1/nGen_13tev)
...
leg.Draw()
c_vtxprob.Print('TMABSDY120superimposition_vtxprob_noLog.pdf')
#
...
pad1.cd()
#pad1.SetLogy()
h1tev_at8tev_MuonProbB.Scale(1/nGen_8tev)
h1tev_at13tev_MuonProbB.Scale(1/nGen_13tev)
...
#h5tev_LeptonEta.GetYaxis().SetRangeUser(0, 0.04 )
#h5tev_prob.GetYaxis().SetLog()
h1tev_at8tev_MuonProbB.Draw("histo")
h1tev_at13tev_MuonProbB.Draw("same histo")
leg.Draw()
pad2.cd()
#pad2.SetLogy()
h1tev_at8tev_MuonProbE.Scale(1/nGen_8tev)
h1tev_at13tev_MuonProbE.Scale(1/nGen_13tev)
...
c_trkprob.Print('TMABSDY120superimposition_trkprob_noLog.pdf')
...
pad1.cd()
#pad1.SetLogy()
h1tev_at8tev_iterB.Scale(1/nGen_8tev)
h1tev_at13tev_iterB.Scale(1/nGen_13tev)
...
pad2.cd()
#pad2.SetLogy()
h1tev_at8tev_iterE.Scale(1/nGen_8tev)
h1tev_at13tev_iterE.Scale(1/nGen_13tev)
#h1tev_at8tev_d0B.Rebin(20)
#h1tev_at13tev_d0B.Rebin(20)
...
leg.Draw()
c_iter.Print('TMABSDY120superimposition_iter.pdf')
...
#c.SetLogy();
h1tev_at8tev_LeptonEta.Scale(1/nGen_8tev)
h1tev_at13tev_LeptonEta.Scale(1/nGen_13tev)
#h5tev_LeptonEta.Rebin(5)
#h1tev_at8tev_LeptonEta.Rebin(5)
#h1tev_at13tev_LeptonEta.Rebin(5)
h1tev_at8tev_LeptonEta.SetLineColor(1)
...
h1tev_at8tev_MuonProb.Scale(1/nGen_8tev)
h1tev_at13tev_MuonProb.Scale(1/nGen_13tev)
...
h1tev_at8tev_prob.Scale(1/nGen_8tev)
h1tev_at13tev_prob.Scale(1/nGen_13tev)
...
c.Print('TMABSDY120superimposition_zprime.pdf')
#
#
#c2 = ROOT.TCanvas( 'c2', '')
##c.Divide(1,2)
