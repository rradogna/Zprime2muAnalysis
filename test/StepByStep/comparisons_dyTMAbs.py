...
leg.AddEntry(h1tev_at8tev, " DY 1.5TeV @ 8TeV (Tracker Muon)", "L")
leg.AddEntry(h1tev_at13tev, " DY 1.5TeV @ 13TeV (Tracker Muon)", "L")
...
leg.Draw()
c_mass.Print('TMABSDYsuperimposition_mass.pdf')
...
hprob_13tev_iterOldBB.SetMaximum(0.022)
...
hprob_13tev_iterOldEE.SetMaximum(0.005)
...
hprob_8tev_iterOldEB.SetMaximum(0.016)
...
c_scat.Print('TMABSDYsuperimposition_iterVSvtxprob.pdf')
...
c_scat.Print('TMABSDYsuperimposition_iterVSprobBarrel.pdf')
...
hprob_13tev_iter0E.Draw("histo")
hprob_8tev_iter0E.Draw("histo same")
#h1tev_at8tev_iterVSprobB_iter0.Draw("colz")
pad2.cd()
...
hprob_13tev_iter2E.Draw("histo")
hprob_8tev_iter2E.Draw("histo same")
pad3.cd()
...
c_scat.Print('TMABSDYsuperimposition_iterVSprobEndcap.pdf')
...
leg.Draw()
c_over.Print('TMABSDYsuperimposition_Chioverflow.pdf')
#
...
#h5tev_prob.GetYaxis().SetLog()
h1tev_at13tev_prob_BB.SetMinimum(0)
...
#h5tev_LeptonEta.GetYaxis().SetRangeUser(0, 0.04 )
#h5tev_prob.GetYaxis().SetLog()
h1tev_at13tev_prob_EB.SetMinimum(0)
h1tev_at13tev_prob_EB.Draw("histo")
h1tev_at8tev_prob_EB.Draw("same histo")
leg.Draw()
c_vtxprob.Print('TMABSDYsuperimposition_vtxprob_noLog.pdf')
#
...
c_trkprob.Print('TMABSDYsuperimposition_trkprob_noLog.pdf')
...
leg.Draw()
c_iter.Print('TMABSDYsuperimposition_iter.pdf')
...
c.Print('TMABSDYsuperimposition_zprime.pdf')
#
#
#c2 = ROOT.TCanvas( 'c2', '')
##c.Divide(1,2)
