...
###################################################################
f1tev_at8tev = ROOT.TFile('./files/zp2mu_dy120_8.root')
...
f1tev_at13tev = ROOT.TFile('./files/zp2mu_dy120_13.root')
...
leg.Draw()
c_mass.Print('ABSDY120superimposition_mass.pdf')
...
c_scat.Print('ABSDY120superimposition_iterVSvtxprob.pdf')
...
c_scat.Print('ABSDY120superimposition_iterVSprobBarrel.pdf')
...
c_scat.Print('ABSDY120superimposition_iterVSprobEndcap.pdf')
...
leg.Draw()
c_over.Print('ABSDY120superimposition_Chioverflow.pdf')
#
...
leg.Draw()
c_vtxprob.Print('ABSDY120superimposition_vtxprob_noLog.pdf')
#
...
c_trkprob.Print('ABSDY120superimposition_trkprob_noLog.pdf')
...
leg.Draw()
c_iter.Print('ABSDY120superimposition_iter.pdf')
...
h1tev_at13tev_MuonProb.Draw("histo")
...
c.Print('ABSDY120superimposition_zprime.pdf')
#
#
#c2 = ROOT.TCanvas( 'c2', '')
##c.Divide(1,2)
