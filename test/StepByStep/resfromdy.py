...
ps = plot_saver('plots_res/resfromdy1500_13')

f = ROOT.TFile('./files/zp2mu_dy1500_13.root')
d = f.ResolutionVertexUsingMC
...
print "NEXT ++++++++++++++++++++++++++++++++++++"
#h2 = d.Get('DileptonMassResVSMuonPtProb')
#h2 = make_rms_hist(h2)
#h2.Draw()
#
#ps.save('mass_res_vs_ptprob')