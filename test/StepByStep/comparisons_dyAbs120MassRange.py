...
h1tev_at8tev = d1tev_at8tev.Get('DileptonMass')
...
h1tev_at13tev = d1tev_at13tev.Get('DileptonMass')
...
leg.AddEntry(h1tev_at8tev, " DY 120GeV @ 8TeV", "L")
leg.AddEntry(h1tev_at13tev, " DY 120GeV @ 13TeV", "L")
...
leg.Draw()
c_mass.Print('MR_ABSDY120superimposition_mass.pdf')
...
hprob_13tev_iterOldEB.SetMaximum(0.01)
...
c_scat.Print('MR_ABSDY120superimposition_iterVSvtxprob.pdf')
...
c_scat.Print('MR_ABSDY120superimposition_iterVSprobBarrel.pdf')
...
c_scat.Print('MR_ABSDY120superimposition_iterVSprobEndcap.pdf')
...
leg.Draw()
c_over.Print('MR_ABSDY120superimposition_Chioverflow.pdf')
#
...
#h5tev_LeptonEta.GetYaxis().SetRangeUser(0, 0.04 )
#h5tev_prob.GetYaxis().SetLog()
h1tev_at13tev_prob_EE.SetMinimum(0.)
...
leg.Draw()
c_vtxprob.Print('MR_ABSDY120superimposition_vtxprob_noLog.pdf')
#
...
c_trkprob.Print('MR_ABSDY120superimposition_trkprob_noLog.pdf')
...
leg.Draw()
c_iter.Print('MR_ABSDY120superimposition_iter.pdf')
...
c.Print('MR_ABSDY120superimposition_zprime.pdf')
#
#
#c2 = ROOT.TCanvas( 'c2', '')
##c.Divide(1,2)
