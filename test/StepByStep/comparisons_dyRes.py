...
#hPtResVStrkprob_13tev.SetMaximum(0.09)
#hPtResVStrkprob_13tev.SetMinimum(0.03)
#hPtResVStrkprob_13tev.Draw()
#hPtResVStrkprob_8tev.Draw('same')
#c_PtresVSprob.Print('ABSDYRES_PtresVSprob.pdf')
#
...
#hInvPtResVStrkprob_13tev.SetMaximum(0.09)
...
hMResVStrkprob_13tev.SetMaximum(0.09)
hMResVStrkprob_13tev.SetMinimum(0.03)
hMResVStrkprob_13tev.Draw()
hMResVStrkprob_8tev.Draw('same')
c_MresVSprob.Print('ABSDYRES_MresVSprob.pdf')
...
hMResVSvtxChi2_13tev.SetLineColor(8)
...
hMResVSvtxChi2_13tev.SetMaximum(0.047)
hMResVSvtxChi2_13tev.SetMinimum(0.04)
...
c_MresVSchi.Print('ABSDYRES_MresVSchi_m.pdf')
...
hMResVSvtxChi2_13tevM.SetLineColor(8)
...
hMResVSvtxChi2_13tevMRMS.SetLineColor(8)
...
#hMResVSvtxChi2_8tevM.Draw('same')
c_MresVSchi.Print('ABSDYRES_MresRMSVSchi_M.pdf')
...
hMResVSvtxChi2_13tevMMean.SetLineColor(8)
...
#hMResVSvtxChi2_8tevM.Draw('same')
c_MresVSchi.Print('ABSDYRES_MresMeanVSchi_M.pdf')
...
h1tev_at13tev_Chi2_overf.SetLineColor(8)
...
h1tev_at13tev_Mres0_3.SetLineColor(8)
h1tev_at13tev_Mres0_3.SetLineWidth(2)
Mres0_3 = TF1("Mres0_3","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres3_5.SetLineColor(8)
h1tev_at13tev_Mres3_5.SetLineWidth(2)
Mres3_5 = TF1("Mres3_5","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres5_10.SetLineColor(8)
h1tev_at13tev_Mres5_10.SetLineWidth(2)
Mres5_10 = TF1("Mres5_10","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres10_15.SetLineColor(8)
h1tev_at13tev_Mres10_15.SetLineWidth(2)
Mres10_15 = TF1("Mres10_15","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres15_20.SetLineColor(8)
h1tev_at13tev_Mres15_20.SetLineWidth(2)
Mres15_20 = TF1("Mres15_20","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres20_30.SetLineColor(8)
h1tev_at13tev_Mres20_30.SetLineWidth(2)
Mres20_30 = TF1("Mres20_30","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres10_30.SetLineColor(8)
h1tev_at13tev_Mres10_30.SetLineWidth(2)
Mres10_30 = TF1("Mres10_30","gaus", -0.1, 0.1)
...
h1tev_at13tev_Mres15_30.SetLineColor(8)
h1tev_at13tev_Mres15_30.SetLineWidth(2)
Mres15_30 = TF1("Mres15_30","gaus", -0.1, 0.1)
...
tMres15_30.SetNDC()
tMres15_30.Draw()
c_MRes_Slice.Print('ABSDYRES_Mres_sliceChi2.pdf')
...
h1tev_at13tev_dxy0_3.SetLineColor(8)
...
h1tev_at13tev_dxy3_5.SetLineColor(8)
...
h1tev_at13tev_dxy5_10.SetLineColor(8)
...
h1tev_at13tev_dxy10_15.SetLineColor(8)
...
h1tev_at13tev_dxy15_20.SetLineColor(8)
...
h1tev_at13tev_dxy20_30.SetLineColor(8)
...
h1tev_at13tev_dxy10_30.SetLineColor(8)
...
h1tev_at13tev_dxy15_30.SetLineColor(8)
...
tdxy15_30.SetNDC()
tdxy15_30.Draw()
c_dxy_Slice.Print('ABSDYRES_dxy_sliceChi2.pdf')
...
h1tev_at13tev_dz0_3.SetLineColor(8)
...
h1tev_at13tev_dz3_5.SetLineColor(8)
...
h1tev_at13tev_dz5_10.SetLineColor(8)
...
h1tev_at13tev_dz10_15.SetLineColor(8)
...
h1tev_at13tev_dz15_20.SetLineColor(8)
...
h1tev_at13tev_dz20_30.SetLineColor(8)
...
h1tev_at13tev_dz10_30.SetLineColor(8)
...
h1tev_at13tev_dz15_30.SetLineColor(8)
...
tdz15_30.SetNDC()
tdz15_30.Draw()
c_dz_Slice.Print('ABSDYRES_dz_sliceChi2.pdf')
...
#c_Pt.Print('ABSDYRESsuperimposition_Pt.pdf')
#
...
#PtResBB_8 = TF1("PtResBB_8","gaus", -0.1, 0.1)
#PtResBB_13 = TF1("PtResBB_13","gaus", -0.1, 0.1)
#h1tev_at13tev_PtResBB.Fit('PtResBB_13', 'R')
#h1tev_at8tev_PtResBB.Fit('PtResBB_8', 'R')
#h1tev_at13tev_PtResBB.Draw("histo")
#h1tev_at8tev_PtResBB.Draw("same histo")
...
#PtResEE_8 = TF1("PtResEE_8","gaus", -0.1, 0.1)
#PtResEE_13 = TF1("PtResEE_13","gaus", -0.1, 0.1)
...
#PtResEB_8 = TF1("PtResEB_8","gaus", -0.1, 0.1)
#PtResEB_13 = TF1("PtResEB_13","gaus", -0.1, 0.1)
...
#tPtResEB.Draw()
#
#c_PtRes.Print('ABSDYRESsuperimposition_PtRes.pdf')
#print "INVPTRES"
...
#InvPtResBB_8 = TF1("InvPtResBB_8","gaus", -0.1, 0.1)
#InvPtResBB_13 = TF1("InvPtResBB_13","gaus", -0.1, 0.1)
#h1tev_at13tev_InvPtResBB.Fit('InvPtResBB_13', 'R')
#h1tev_at8tev_InvPtResBB.Fit('InvPtResBB_8', 'R')
#h1tev_at13tev_InvPtResBB.Draw("histo")
#h1tev_at8tev_InvPtResBB.Draw("same histo")
...
#InvPtResEE_8 = TF1("InvPtResEE_8","gaus", -0.1, 0.1)
#InvPtResEE_13 = TF1("InvPtResEE_13","gaus", -0.1, 0.1)
...
#InvPtResEB_8 = TF1("InvPtResEB_8","gaus", -0.1, 0.1)
#InvPtResEB_13 = TF1("InvPtResEB_13","gaus", -0.1, 0.1)
#h1tev_at13tev_InvPtResEB.Fit('InvPtResEB_13', 'R')
#h1tev_at8tev_InvPtResEB.Fit('InvPtResEB_8', 'R')
#h1tev_at13tev_InvPtResEB.Draw("histo")
#h1tev_at8tev_InvPtResEB.Draw("same histo")
...
#tInvPtResEB.Draw()
#
#c_InvPtRes.Print('ABSDYRESsuperimposition_InvPtRes.pdf')
#print "PULL"
...
#tPtPullEB.SetNDC()
#tPtPullEB.Draw()
#c_PtPull.Print('ABSDYRESsuperimposition_PtPull.pdf')
#print "MRES"
...
#MresBB_8 = TF1("MresBB_8","gaus", -0.1, 0.1)
#MresBB_13 = TF1("MresBB_13","gaus", -0.1, 0.1)
...
#MresEE_8 = TF1("MresEE_8","gaus", -0.1, 0.1)
#MresEE_13 = TF1("MresEE_13","gaus", -0.1, 0.1)
...
#MresEB_8 = TF1("MresEB_8","gaus", -0.1, 0.1)
#MresEB_13 = TF1("MresEB_13","gaus", -0.1, 0.1)
...
#tMresEB.SetNDC()
#tMresEB.Draw()
#c_mRes.Print('ABSDYRESsuperimposition_MRes.pdf')