...
leg.Draw()
c_mass.Print('ABSDYsuperimposition_mass.pdf')
...
c_scat.Print('ABSDYsuperimposition_iterVSvtxprob.pdf')
...
c_scat.Print('ABSDYsuperimposition_iterVSprobBarrel.pdf')
...
c_scat.Print('ABSDYsuperimposition_iterVSprobEndcap.pdf')
...
leg.Draw()
c_over.Print('ABSDYsuperimposition_Chioverflow.pdf')
#
...
leg.Draw()
c_vtxprob.Print('ABSDYsuperimposition_vtxprob_noLog.pdf')
#
...
#h5tev_LeptonEta.GetYaxis().SetRangeUser(0, 0.04 )
#h5tev_prob.GetYaxis().SetLog()
h1tev_at13tev_MuonProbE.Draw("histo")
h1tev_at8tev_MuonProbE.Draw("same histo")
leg.Draw()

c_trkprob.Print('ABSDYsuperimposition_trkprob_noLog.pdf')
...
leg.Draw()
c_iter.Print('ABSDYsuperimposition_iter.pdf')
...
c.Print('ABSDYsuperimposition_zprime.pdf')
#
#
#c2 = ROOT.TCanvas( 'c2', '')
##c.Divide(1,2)
