...
process.p2  = cms.Path(process.HardInteractionFilterRes * process.goodDataFilter*process.muonPhotonMatch * process.leptons * process.allDimuons * process.dimuonsNoVtxProb * process.HistosFromPAT * process.ResolutionVertexUsingMC)
...
events_per_job = 50000
    ''')
        ...
        for sample in reversed(samples):
            print sample.name
            new_py = open('histos_noVtxCut.py').read()
            ...
            open('histos_noVtxCut_crab.py', 'wt').write(new_py)
