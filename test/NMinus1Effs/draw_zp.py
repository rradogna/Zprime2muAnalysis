...
data, lumi = nm1entry('data', True), 1. # lumi in pb
mcsum = nm1entry('mcsum')

from SUSYBSMAnalysis.Zprime2muAnalysis.MCSamples import dy120
raw_samples = [dy120]#dy120]#dy200 zpsi5000
...
#    '800m1200':    [data, mcsum], #, dy500_c1, ttbar],
    'fullm':    [data, mcsum], #, dy500_c1, ttbar],
    }

styles = {
    'mcsum':     (ROOT.kRed, 1001),
    'data':      (ROOT.kBlack,     -1),
    #'mcsum':     (ROOT.kMagenta, 1001),
    #'mcsum':     (ROOT.kGreen, 1001),
